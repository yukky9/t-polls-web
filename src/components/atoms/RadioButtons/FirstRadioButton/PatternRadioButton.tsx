...
const PatternRadioButton = () => {
    return (
        <div className='flex items-center justify-center gap-10'>
            <div className="flex gap-10">
                <a href='/createPattern'>
                ...
                <a href='/generatePattern'>
                    <div className="inline-flex items-center">
                        ...
                        <label className="ml-2 text-xl text-black cursor-pointer">Сгененрировать</label>
                    </div>
                </a>
            </div>
        </div>
...
export default PatternRadioButton;